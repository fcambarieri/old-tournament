...
public class DefaultSwingGlassPane extends JComponent implements MouseListener {
    ...
    public DefaultSwingGlassPane() {
        this("");
    }
    
    public DefaultSwingGlassPane(String text) {
        this(text, 14);
    }
    
    public DefaultSwingGlassPane(String text, int barsCount) {
        this(text, barsCount, 0.35f);
    }
    
    public DefaultSwingGlassPane(String text, int barsCount, float shield) {
        this(text, barsCount, shield, 15.0f);
    }
    
    public DefaultSwingGlassPane(String text, int barsCount, float shield, float fps) {
        this(text, barsCount, shield, fps, 300);
    }
    
    public DefaultSwingGlassPane(String text, int barsCount, float shield, float fps, int rampDelay) {
        this.text 	   = text;
    ...
    protected class Animator implements Runnable {
        ...
        public void run() {
            ...
            if (!rampUp) {
                ...
                setVisible(false);
                removeMouseListener(DefaultSwingGlassPane.this);
            }
        }
    }
